#ifndef OID_MOTOR_DRIVER_HPP
#define OID_MOTOR_DRIVER_HPP
#include <mutex>
#include <string>
...
namespace arm {
class OidMotorDriver : public MotorDriver {
 public:
  OidMotorDriver(uint16_t motor_id, std::string can_interface);
  ~OidMotorDriver();
 ...
 private:
  ...
  void CanRxMsgCallback(const can_frame& rx_frame, uint8_t comm_mode);
